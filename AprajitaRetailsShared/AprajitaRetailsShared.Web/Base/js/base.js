//=========================================================================
// Project  :   Shared.Web.Layout.Core.Base.js
// Model    :   base
//=========================================================================
...
(function ($) {
    ...
    var Pages = function () {
        this.VERSION = "1.0.0";
        this.AUTHOR = "Leno Carvalho";
        this.SUPPORT = "lcarva16@outlook.com";
    ...
    Pages.prototype.initSwitcheryPlugin = function () {
        ...
        window.Switchery && $('.js-switch').each(function () {
            var el = $(this);
...
; (function (window) {
    ...
    SelectFx.prototype._init = function () {
        ...
        if (selectedOpt == null) {
            ...
            var find = $('option[value="' + value + '"]', this.el);
            if (find
                && find.length > 0) {
                selectedOpt = find[0];
            }
    ...
    SelectFx.prototype._createSelectEl = function () {
        ...
        [].slice.call(this.el.children).forEach(function (el) {
            ...
            if (tag === 'option') {
                var created = createOptionHTML(el);
                if (created) {
                    options += created;
                }
                ...
                [].slice.call(el.children).forEach(function (opt) {
                    var optCreated = createOptionHTML(opt);
                    if (optCreated) {
                        options += optCreated;
                    }
                })
        ...
        this.selEl.innerHTML = '<span class="cs-placeholder">' + (this.selectedOpt.textContent || 'Selecione uma opção...') + '</span>' + opts_el;
...
(function ($) {
    ...
    Sidebar.prototype.togglePinSidebar = function (toggle) {
        ...
        if (localStorage.getItem('body-classes')) {
            localStorage['body-classes'] = classes;
        }
        else {
            localStorage.setItem('body-classes', classes);
        }
    }
