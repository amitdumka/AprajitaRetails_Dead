...
(function () {
    ...
    angular
        .module('shared')
        .controller('submenusCtrl', ['Core', 'Alerts', 'Exceptions', 'Layouts', 'Modals',
            function (Core, Alerts, Exceptions, Layouts, Modals) {
                ...
                // Layout definition
                Class.Layout = Layouts.Get('submenus');
                ...
                function _Start() {
                    Modals.Loading();
                    Core.Configure('submenus as Submenus', Class);
