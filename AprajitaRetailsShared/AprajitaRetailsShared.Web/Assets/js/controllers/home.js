...
(function () {
    ...
    angular
        .module('shared')
        .controller('homeCtrl', ['Core', 'Alerts', 'Exceptions', 'Layouts', 'Modals',
            function (Core, Alerts, Exceptions, Layouts, Modals) {
                ...
                function _Start() {
                    Modals.Loading();
                    Core.Configure('home as Página Inicial', Class);
