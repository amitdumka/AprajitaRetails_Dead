...
(function () {
    ...
    angular
        .module('shared')
        .controller('maintenanceCtrl', ['Core', 'Alerts', 'Exceptions', 'Layouts', 'Modals',
            function (Core, Alerts, Exceptions, Layouts, Modals) {
                ...
                // Layout definition
                Class.Layout = Layouts.Get('maintenance');
                ...
                function _Start() {
                    Modals.Loading();
                    Core.Configure('maintenance as Manutenção', Class);
