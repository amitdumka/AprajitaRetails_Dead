...
(function () {
    ...
    angular
        .module('shared')
        .controller('logsCtrl', ['Core', 'Alerts', 'Exceptions', 'Layouts', 'Modals',
            function (Core, Alerts, Exceptions, Layouts, Modals) {
                ...
                function _Start() {
                    Modals.Loading();
                    Core.Configure('logs as Registros', Class);
