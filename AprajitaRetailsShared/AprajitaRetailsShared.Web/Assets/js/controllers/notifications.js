...
(function () {
    ...
    angular
        .module('shared')
        .controller('notificationsCtrl', ['Core', 'Alerts', 'Exceptions', 'Layouts', 'Modals',
            function (Core, Alerts, Exceptions, Layouts, Modals) {
                ...
                // Layout definition
                Class.Layout = Layouts.Get('notifications');
                ...
                function _Start() {
                    Modals.Loading();
                    Core.Configure('notifications as Notificações', Class);
