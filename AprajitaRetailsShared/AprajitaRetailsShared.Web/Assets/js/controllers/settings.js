...
(function () {
    ...
    angular
        .module('shared')
        .controller('settingsCtrl', ['Core', 'Alerts', 'Exceptions', 'Layouts', 'Modals',
            function (Core, Alerts, Exceptions, Layouts, Modals) {
                ...
                // Layout definition
                Class.Layout = Layouts.Get('settings');
                ...
                function _Start() {
                    Modals.Loading();
                    Core.Configure('settings as Configurações', Class);
