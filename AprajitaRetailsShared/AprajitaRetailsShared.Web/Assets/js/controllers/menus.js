...
(function () {
    ...
    angular
        .module('shared')
        .controller('menusCtrl', ['Core', 'Alerts', 'Exceptions', 'Layouts', 'Modals',
            function (Core, Alerts, Exceptions, Layouts, Modals) {
                ...
                // Layout definition
                Class.Layout = Layouts.Get('menus');
                ...
                function _Start() {
                    Modals.Loading();
                    Core.Configure('menus as Menus', Class);
