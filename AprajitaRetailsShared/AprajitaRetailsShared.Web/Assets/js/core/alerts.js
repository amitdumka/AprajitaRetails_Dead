...
(function () {
    ...
    angular
        .module('shared')
        .factory('Alerts', ['Culture', 'Exceptions',
            function (Culture, Exceptions) {
                // Class definition
                var Class = {
                    Logging: {
                        Enabled: true,
                    ...
                    if (data && data !== null) {
                        if (typeof data !== 'string') {
                            if (data.responseText) {
                                ...
                                content = data.Message[Culture.Default];
                                if (!content) {
                                    Alerts.Error('There is no message defined for this exception code or the specified culture does not exists');
                                }

                                if (data.Details) {
                                    content += '\n\n' + data.Details[Culture.Default];
                                    if (data.Solution) {
                                        content += '\n\n' + data.Solution[Culture.Default];
                                    }
                                }
                            }
                            else {
